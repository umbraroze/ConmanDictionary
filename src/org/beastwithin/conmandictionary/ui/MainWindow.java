...
public class MainWindow extends javax.swing.JFrame {
    ...
    /**
     *  All of the Swing nitty-gritty for creating the window contents.
     */
    private void createWindowContents() {
        ...
        leftLanguagePanel = new LanguagePanel();
        rightLanguagePanel = new LanguagePanel();
        ...
        fileMergeMenuItem = new JMenuItem();
        fileExportDictdMenuItem = new JMenuItem();
        fileQuitSeparator = new JPopupMenu.Separator();
        fileQuitMenuItem = new JMenuItem();

        researchMenu = new JMenu();
        researchNotepadMenuItem = new JMenuItem();
        researchStatisticsMenuItem = new JMenuItem();

        settingsMenu = new JMenu();
        settingsSaveFlaggedMenuItem = new JCheckBoxMenuItem();
        settingsLanguageNamesMenuItem = new JMenuItem();
        settingsWordClassesMenuItem = new JMenuItem();
        settingsCategoriesMenuItem = new JMenuItem();
        ...
        pack();
    }// </editor-fold>//GEN-END:createWindowContents
